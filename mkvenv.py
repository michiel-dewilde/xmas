...
subprocess.call([vpip, 'install', '--upgrade', 'git+https://github.com/pytroll/aggdraw', 'numpy==1.19.3', 'pillow', 'pylint', 'scipy', 'git+https://github.com/Zulko/moviepy.git', 'xlrd'])
